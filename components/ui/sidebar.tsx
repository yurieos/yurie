...
import { SidebarSimple as PhosphorSidebar } from "@phosphor-icons/react"
...
function Sidebar({
  ...
  // Mobile: Overlay floating sidebar
  if (isMobile) {
    return (
      <>
        {/* Backdrop overlay */}
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          // Floating variant: sidebar width, no gap
          "w-(--sidebar-width)"
        )}
      />
      <div
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      <PhosphorSidebar className="size-5" />
